...
import { Bike, Calendar, Clock, Trophy, Users, Utensils } from 'lucide-react'
          ...
          <motion.div className="mx-auto max-w-4xl text-center" variants={itemVariants}>
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <Utensils className="mx-auto mb-2 h-6 w-6 text-[#D72638] dark:text-[#FFA5A5]" />
                <p className="text-sm font-semibold text-gray-800 dark:text-gray-200">
                  🍖 BBQ inklusive
                </p>
              </motion.div>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-16">
          <div className="relative h-[500px] w-full overflow-hidden rounded-3xl shadow-2xl lg:h-[600px]">
            <Image
              src="/images/MTB-Fitness-Camp-Fitnessbaecker-Baeckerei-Noventa-768x463.jpg"
            ...
            <div className="absolute right-6 bottom-6 left-6">
              <div className="rounded-2xl bg-white/90 p-6 backdrop-blur-sm dark:bg-[#232323]/90">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Von Geschicklichkeitsparcours bis zur geführten Tour - ein Tag voller
                  Radsport-Abenteuer
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              >
                ...
                <div className="space-y-2">
                  <p className="text-gray-700 dark:text-gray-300">
                    <span className="font-semibold">Datum:</span> {translations.details.date}
                  </p>
                  <p className="text-gray-700 dark:text-gray-300">
                    <span className="font-semibold">Zeit:</span> {translations.details.time}
                  </p>
                  <p className="text-gray-700 dark:text-gray-300">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {translations.highlights.map((highlight, index) => (
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                >
                  <Trophy className="mt-0.5 h-5 w-5 flex-shrink-0 text-[#D72638] dark:text-[#FFA5A5]" />
