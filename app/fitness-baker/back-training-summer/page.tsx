...
import { Activity, Calendar, Clock, MapPin, Star, Target, Users } from 'lucide-react'
          ...
          <motion.div className="mx-auto max-w-4xl text-center" variants={itemVariants}>
            ...
            >
              ...
              >
                ...
                <p className="text-sm font-semibold text-gray-800 dark:text-gray-200">👥 Max. 14</p>
              </motion.div>
              <motion.div
                className="rounded-xl border border-[#FAD2E1] bg-white p-4 shadow-lg dark:border-[#444444] dark:bg-[#232323]"
                whileHover={{ scale: 1.05, y: -5 }}
              ...
              >
                ...
                <p className="text-sm font-semibold text-gray-800 dark:text-gray-200">☀️ Sommer</p>
              </motion.div>
            </motion.div>
          </motion.div>
        </div>
      ...
      >
            ...
            <div className="absolute right-6 bottom-6 left-6">
              <div className="rounded-2xl bg-white/90 p-6 backdrop-blur-sm dark:bg-[#232323]/90">
                <h3 className="mb-2 text-2xl font-bold text-[#D72638] dark:text-[#FFA5A5]">
                  Rückentraining 2.0 - Das neue Level
                </h3>
                <p className="text-gray-700 dark:text-gray-300">
                  Mit TRX-System und modernsten Trainingsmethoden für einen starken, gesunden Rücken
                </p>
              </div>
            </div>
          </div>
        ...
        <motion.div variants={itemVariants} className="mx-auto max-w-4xl">
          <div className="rounded-3xl border border-[#FAD2E1] bg-white p-8 shadow-2xl lg:p-12 dark:border-[#444444] dark:bg-[#232323]">
            ...
            <motion.div
              className="rounded-2xl bg-gradient-to-r from-[#FFF5E1] to-[#FFE2E2] p-6 dark:from-[#2a2a2a] dark:to-[#333333]"
